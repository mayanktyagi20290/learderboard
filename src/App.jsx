      ...
      <div style={{ display: "flex" }}>
        ...
        <aside className="sidebar-desktop" style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2, flex: 1 }}>
            {NAV_ITEMS.map((item) => (
              <div key={item.label} className="navrow" style={{
                display: "flex", alignItems: "center", gap: 12, padding: "10px 12px", borderRadius: 12, cursor: "pointer",
                background: item.active ? (dark ? "rgba(91,61,245,0.22)" : "rgba(91,61,245,0.1)") : "transparent",
                color: item.active ? BRAND.primaryLight : T.text, fontWeight: item.active ? 700 : 500, fontSize: 13.5,
              }}>
        ...
        <div className="content-wrap" style={{ marginLeft: 226, flex: 1, minWidth: 0 }}>
          ...
          <div style={{ padding: "26px 28px 80px", maxWidth: 1320, margin: "0 auto" }}>
            {/* ---------------- HERO ---------------- */}
            <div className="hoverlift" style={{ ...cardStyle, borderRadius: 28, padding: "30px 32px", position: "relative", overflow: "hidden", marginBottom: 22 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 24, alignItems: "center", position: "relative" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8, minWidth: 210 }}>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    <button className="btn-primary hoverlift" style={{ flex: 1, borderRadius: 10, padding: "10px 8px", fontSize: 12.5, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                      <Share2 size={14} /> Share link
                    </button>
                    <button className="btn-ghost hoverlift" style={{ border: T.panelBorder, borderRadius: 10, padding: "10px 12px", fontSize: 12.5, fontWeight: 700, color: T.text, display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: 20, marginBottom: 22 }}>
              ...
              {/* Daily Missions */}
              <div className="hoverlift" style={{ ...cardStyle, borderRadius: 24, padding: "22px 20px", minWidth: 0 }}>
